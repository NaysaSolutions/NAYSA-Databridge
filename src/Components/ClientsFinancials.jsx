...
const ClientsFinancials = () => {
  ...
  // Sorting state - default to client_code ascending
  ...
  // Improved sorting function with client_code as secondary sort
  ...
  // Memoized sorted clients with secondary sort by client_code
  const sortedClients = useMemo(() => {
    ...
    return [...filteredClients].sort((a, b) => {
      ...
      // If primary sort is equal, sort by client_code
  ...
  const currentItems = sortedClients.slice(
        ...
        <div className="bg-white shadow-lg rounded-xl overflow-hidden">
                ...
                {currentItems.map((client, index) => (
                  ...
                  >
                    ...
                    <td className="px-2 py-2 border">
                      {client.contract_date ? new Intl.DateTimeFormat('en-US', {
                        year: 'numeric',
                        month: '2-digit',
                        day: '2-digit',
                    ...
                    <td className="px-2 py-2 border">
                      {client.sma_date ? new Intl.DateTimeFormat('en-US', {
                        year: 'numeric',
                        month: '2-digit',
                        day: '2-digit',
          ...
          <div className="flex justify-between items-center p-4 bg-gray-50 border-t text-sm text-gray-700">
            <span>
              ...
              {Math.min(currentPage * itemsPerPage, sortedClients.length)} of {sortedClients.length}
            </span>
