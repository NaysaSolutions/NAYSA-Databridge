...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
  ...
  <div className="bg-white p-4 rounded-lg shadow-md h-96">
    ...
    <ResponsiveContainer width="100%" height="100%">
      <BarChart data={systemUsage} margin={{ bottom: 40 }}>
        <XAxis dataKey="system_code" interval={0} height={60} />
  ...
  <div className="bg-white p-4 rounded-lg shadow-md h-96">
    ...
    {SMADashboard.length > 0 ? (
      ...
      <p className="text-gray-500 mt-8">No SMA data available.</p>
    )}
  </div>
  ...
  <div className="bg-white p-4 rounded-lg shadow-md h-96">
    ...
    {Industry.length > 0 ? (
      ...
      <p className="text-gray-500 mt-8">No industry data available.</p>
    )}
  </div>
  ...
  <div className="bg-white p-4 rounded-lg shadow-md h-96">
    ...
    <ResponsiveContainer width="100%" height="100%">
      <BarChart data={SMAApplication} margin={{ bottom: 40 }}>
        <XAxis dataKey="system_code" interval={0} height={60} />
        <Tooltip formatter={(value) => [value, "Clients"]} />
        <Bar dataKey="client_count">
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
          <StatCard title="Active Clients" value={+activeClients?.[0]?.total_active_clients || 0} />
          <StatCard title="Clients with SMA" value={+smaSummary?.[0]?.with_sma || 0} color="blue" />
          <StatCard title="Expiring SMA" value={+smaSummary?.[0]?.expiring_soon || 0} color="yellow" />
        </div>

        {/* Tables */}
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
          <MiniTable title="Expired SMA (Today)" data={ExpiredSMA} />
          <MiniTable title="Upcoming SMA Expirations (60 Days)" data={upcomingExpirations} />
        </div>
